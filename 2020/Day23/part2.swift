...
var dictCupPointer = currentCup
for _ in 1...1000000 {
	cupDict[dictCupPointer.label] = dictCupPointer
	dictCupPointer = dictCupPointer.next
}
...
for c in 1...10000000 {
	...
	let destinationCup = cupDict[destinationCupValue]!
